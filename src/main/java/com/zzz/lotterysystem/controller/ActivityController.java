...
import com.zzz.lotterysystem.controller.result.FindActivityListResult;
import com.zzz.lotterysystem.controller.result.FindPrizeListResult;
import com.zzz.lotterysystem.controller.result.GetActivityDetailResult;
...
public class ActivityController {
    ...
    public CommonResult<FindActivityListResult> findActivityList(PageParam param){
        ...
        return CommonResult.success(
                convertToFindActivityListResult(activityService.findActivityList(param)));
